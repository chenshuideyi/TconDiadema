package com.csdy.tcondiadema.effect.register;


import com.csdy.tcondiadema.TconDiadema;
import com.csdy.tcondiadema.effect.*;
...
public class EffectRegister {
    public static final DeferredRegister<MobEffect> EFFECTS = DeferredRegister.create(ForgeRegistries.MOB_EFFECTS, TconDiadema.MODID);
