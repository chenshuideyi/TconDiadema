...
public class AbyssClientDiadema extends ClientDiadema {
    ...
    private static final double RADIUS = com.csdy.tcondiadema.diadema.abyss.AbyssDiadema.RADIUS, LENGTH = 8, HUP = com.csdy.tcondiadema.diadema.abyss.AbyssDiadema.HUP, HDOWN = com.csdy.tcondiadema.diadema.abyss.AbyssDiadema.HDOWN;
